...
public interface ScrapperLinksClient {
    @PostExchange
    ResponseEntity<?> post(@PathVariable Long id, @RequestBody AddLinkRequest request);

    @GetExchange
    ResponseEntity<?> get(@PathVariable Long id);

    @DeleteExchange
    ResponseEntity<?> delete(@PathVariable Long id, @RequestBody RemoveLinkRequest request);
